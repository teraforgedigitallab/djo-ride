...
import UserManagementTab from '../sections/Admin/UserManagementTab';
import BookingManagementTab from '../sections/Admin/BookingManagementTab';
import PasswordModal from '../sections/Admin/PasswordModal';
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-gray-600">Manage users and bookings</p>
                    </div>
                </div>
